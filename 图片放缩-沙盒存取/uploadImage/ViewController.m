...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    NSString *testPath = @"/var/mobile/Containers/Data/Application/32E11D58-7F2D-407C-9DF8-A5EB8AD59951/Library/appdata/one/chat/two/messages/thumb_60e48c50-c883-11e5-9d6a-61e3e707c31e";
    UIImage *savedImage = [[UIImage alloc] initWithContentsOfFile:fullPath];
    UIImage *testImage = [[UIImage alloc] initWithContentsOfFile:testPath];
